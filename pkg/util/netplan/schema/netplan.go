...
type NetworkConfig struct {
	Bonds        map[string]BondConfig        `json:"bonds"`
	Bridges      map[string]BridgeConfig      `json:"bridges"`
	DummyDevices map[string]DummyDeviceConfig `json:"dummy-devices"`
	...
	Vrfs         map[string]VrfsConfig        `json:"vrfs"`
	Wifis        map[string]WifiConfig        `json:"wifis"`
}
...
type BondConfig struct {
	...
	ActivationMode *Lowercase `json:"activation-mode"`
	...
	// network.
	Addresses []AddressMapping `json:"addresses"`
	...
	DHCPIdentifier *string `json:"dhcp-identifier"`
	// Enable DHCP for IPv4. Off by default.
	Dhcp4 *bool `json:"dhcp4"`
	// (networkd backend only) Overrides default DHCP behavior
	Dhcp4Overrides *DHCPOverrides `json:"dhcp4-overrides"`
	...
	// (networkd backend only) Overrides default DHCP behavior
	Dhcp6Overrides *DHCPOverrides `json:"dhcp6-overrides"`
	...
	// carrier.
	IgnoreCarrier *bool `json:"ignore-carrier"`
	...
	// or stable-privacy.
	Ipv6AddressGeneration *Ipv6AddressGeneration `json:"ipv6-address-generation"`
	...
	Ipv6Privacy *bool `json:"ipv6-privacy"`
	...
	OptionalAddresses []string `json:"optional-addresses"`
	...
	Parameters *BondParameters `json:"parameters"`
	...
	Routes []RoutingConfig `json:"routes"`
...
type DHCPOverrides struct {
	...
	RouteMetric *int64 `json:"route-metric"`
	...
	UseHostname *bool `json:"use-hostname"`
...
type BondParameters struct {
	...
	AdSelect *AdSelect `json:"ad-select"`
	...
	AllSlavesActive *bool `json:"all-slaves-active"`
	...
	ARPAllTargets *ARPAllTargets `json:"arp-all-targets"`
	...
	// as milliseconds.
	ARPInterval *string `json:"arp-interval"`
	...
	// an empty list.
	ARPIPTargets []string `json:"arp-ip-targets"`
	...
	ARPValidate *ARPValidate `json:"arp-validate"`
	...
	DownDelay *string `json:"down-delay"`
	...
	// and follow.
	FailOverMACPolicy *FailOverMACPolicy `json:"fail-over-mac-policy"`
	...
	// active-backup mode.
	GratuitousARP *int64 `json:"gratuitous-arp"`
	...
	LACPRate *LACPRate `json:"lacp-rate"`
	...
	LearnPacketInterval *string `json:"learn-packet-interval"`
	...
	MiiMonitorInterval *string `json:"mii-monitor-interval"`
	// The minimum number of links up in a bond to consider the bond interface to be up.
	MinLinks *int64 `json:"min-links"`
	...
	PacketsPerSlave *int64 `json:"packets-per-slave"`
	...
	PrimaryReselectPolicy *PrimaryReselectPolicy `json:"primary-reselect-policy"`
	...
	ResendIGMP *int64 `json:"resend-igmp"`
	...
	TransmitHashPolicy *TransmitHashPolicy `json:"transmit-hash-policy"`
...
type RoutingPolicy struct {
	...
	TypeOfService *string `json:"type-of-service"`
}
...
type BridgeConfig struct {
	...
	// below. If necessary, time intervals can be qualified using a time suffix (such as “s” for
	// seconds, “ms” for milliseconds) to allow for more control over its behavior.
	Parameters *BridgeParameters `json:"parameters"`
	// Use the given networking backend for this definition. Currently supported are networkd
	// and NetworkManager. This property can be specified globally in network:, for a device
	// type (in e. g. ethernets:) or for a particular device definition. Default is networkd.
	//
...
type BridgeParameters struct {
	...
	AgeingTime *string `json:"ageing-time"`
	...
	PortPriority *int64 `json:"port-priority"`
...
type EthernetConfig struct {
	...
	DelayVirtualFunctionsRebind *bool `json:"delay-virtual-functions-rebind"`
	// (networkd backend only) Sets the source of DHCPv4 client identifier. If mac is specified,
	// the MAC address of the link is used. If this option is omitted, or if duid is specified,
	// networkd will generate an RFC4361-compliant client identifier for the interface by
	// combining the link’s IAID and DUID.
	...
	EmbeddedSwitchMode *EmbeddedSwitchMode `json:"embedded-switch-mode"`
	// (networkd backend only) Whether to emit LLDP packets. Off by default.
	EmitLldp *bool `json:"emit-lldp"`
	// Deprecated, see Default routes. Set default gateway for IPv4/6, for manual address
	// configuration. This requires setting addresses too. Gateway IPs must be in a form
	// recognized by inet_pton(3). There should only be a single gateway per IP address family
	// set in your global config, to make it unambiguous. If you need multiple default routes,
	...
	GenericReceiveOffload *bool `json:"generic-receive-offload"`
	...
	GenericSegmentationOffload *bool `json:"generic-segmentation-offload"`
	// (networkd backend only) Allow the specified interface to be configured even if it has no
	// carrier.
	IgnoreCarrier *bool `json:"ignore-carrier"`
	// Configure method for creating the address for use with RFC4862 IPv6 Stateless Address
	...
	// (networkd backend only) If set to true, the Generic Receive Offload (GRO) is enabled.
	// When unset, the kernel’s default will be used.
	LargeReceiveOffload *bool `json:"large-receive-offload"`
	...
	// vlan properties.
	Openvswitch *OpenVSwitchConfig `json:"openvswitch"`
	// An optional device is not required for booting. Normally, networkd will wait some time
	// for device to become configured before proceeding with booting. However, if a device is
	// marked as optional, networkd will not wait for it. This is only supported by networkd,
	// and the default is false.
	...
	ReceiveChecksumOffload *bool `json:"receive-checksum-offload"`
	// Use the given networking backend for this definition. Currently supported are networkd
	// and NetworkManager. This property can be specified globally in network:, for a device
	// type (in e. g. ethernets:) or for a particular device definition. Default is networkd.
	//
	...
	// When unset, the kernel’s default will be used.
	TCPSegmentationOffload *bool `json:"tcp-segmentation-offload"`
	...
	Tcp6SegmentationOffload *bool `json:"tcp6-segmentation-offload"`
	// (networkd backend only) If set to true, the hardware offload for checksumming of egress
	// network packets is enabled. When unset, the kernel’s default will be used.
	TransmitChecksumOffload *bool `json:"transmit-checksum-offload"`
	...
	VirtualFunctionCount *int64 `json:"virtual-function-count"`
...
type OpenVSwitchConfig struct {
	...
	Protocols []OpenFlowProtocol `json:"protocols"`
	// Valid for bridge interfaces. False by default.
	RTSP *bool `json:"rtsp"`
...
type ControllerConfig struct {
	...
	ConnectionMode *ConnectionMode `json:"connection-mode"`
}
...
type WireGuardPeer struct {
	...
	Keys *WireGuardPeerKey `json:"keys"`
}
...
type WifiConfig struct {
	...
	AccessPoints map[string]AccessPointConfig `json:"access-points"`
	// Allows specifying the management policy of the selected interface. By default, netplan
	// brings up any configured interface if possible. Using the activation-mode setting users
	// can override that behavior by either specifying manual, to hand over control over the
	// interface state to the administrator or (for networkd backend only) off to force the link
	...
	// flag (the default).
	Wakeonwlan []WakeOnWLAN `json:"wakeonwlan"`
}
...
type AccessPointConfig struct {
	...
	Mode *AccessPointMode `json:"mode"`
...
type AuthConfig struct {
	...
	AnonymousIdentity *string `json:"anonymous-identity"`
	...
	ClientKeyPassword *string `json:"client-key-password"`
	...
	KeyManagement *KeyManagmentMode `json:"key-management"`
	...
	Phase2Auth *string `json:"phase2-auth"`
}
